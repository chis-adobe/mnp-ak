...
export default async function init(el) {
  ...
  // Row 1: Top bar with logo + utility nav
  ...
  topBar.append(logo, utilityNav);

  // Row 2: Main nav with flyouts
  ...
  // Remaining rows are nav items with flyouts
  // Each row: col1=section name, col2=h3 heading, col3-5=link columns
